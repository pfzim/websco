...
function register_user(&$core, $params, $post_data)
{
	$result_json = array(
		'code' => 0,
		'message' => '',
...
EOT;
		...
		$html .= 'To approve new registered user follow this link: <a href="'.WS_URL.'/form_approve/'.$user_id.'">'.WS_URL.'/form_approve/'.$user_id.'</a>';

		$html .= '</body></html>';

		$plain = 'To approve new registered user follow this link: '.WS_URL.'/form_approve/'.$user_id;
