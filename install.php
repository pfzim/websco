			...
			switch($action)
			{
				...
				case 'check_ldap':
				{
					...
					if($ldap)
					{
						...
						if($bind)
						{
							$sr = ldap_search($ldap, @$_POST['ldap_base'], '(&(objectClass=user)(objectCategory=person))', array('samaccountname'));
							if($sr)
							{
	...
	<body>
		...
		<form id="uform-fields" action="?action=download_config" method="post" target="_blank">
			...
			<div class="form-group">
				...
				<div class="col-sm-5">
					<input id="db_user" name="db_user" class="form-control" type="text" value="webscouser" />
				</div>
			</div>
			<div class="form-group">
			...
			<div class="form-group">
				<label for="use_gssapi" class="control-label col-sm-2">Use GSSAPI for LDAP and SCORCH:</label>
				<div class="col-sm-5">
					<input id="use_gssapi" name="use_gssapi" class="form-control" type="checkbox" value="1" />
				</div>
			</div>
			<div class="form-group">
				<div class="col-sm-offset-2 col-sm-5">
			...
			<div class="form-group">
				...
				<div class="col-sm-5">
					<input id="scorch_passwd" name="scorch_passwd" class="form-control" type="password" value="" />
				</div>
			</div>
			<div class="form-group">
				<div class="col-sm-offset-2 col-sm-5">
